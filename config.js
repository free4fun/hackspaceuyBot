let settings = {
  ...
  ircBlacklist: process.env.IRC_BLACKLIST ? process.env.IRC_BLACKLIST.split(",") : [],
  ircMasterlist: process.env.IRC_MASTERLIST ? process.env.IRC_MASTERLIST.split(",") : [],
  ircMasterpass: process.env.IRC_MASTERPASS ? process.env.IRC_MASTERPASS : "password",
  irc: {
    ...
    botUsername: process.env.IRC_USERNAME || "teleirc",
    botRealname: process.env.IRC_REALNAME || "teleirc bot",
